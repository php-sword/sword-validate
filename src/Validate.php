...
use Closure;
use sword\validate\exception\ValidateException;
use sword\validate\validate\ValidateRule;
...
class Validate
{
     ...
     * @return $this
     */
    public function rule(string|array $name, $rule = ''): static
    {
        if (is_array($name)) {
    ...
    public function is($value, string $rule, array $data = []): bool
    {
        ...
        return match (Helper::camel($rule)) {
